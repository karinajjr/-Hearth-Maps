...
const NavigationMenu = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 w-full bg-white border-t border-[#DCDCDC] shadow-lg rounded-t-3xl p-2 flex justify-around z-50">
      ...
      <div
        className="flex flex-col items-center cursor-pointer custom-navigator"
      ...
      <div
        className="flex flex-col items-center cursor-pointer custom-lactation"
      ...
      <div
        className="flex flex-col items-center cursor-pointer custom-period-kits"
      ...
      <div
        className="flex flex-col items-center cursor-pointer custom-taxi"
